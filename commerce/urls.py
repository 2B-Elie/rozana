...
from .views import CustomLoginView, UserRegisterView, ProfileView, ProductDetailView,product_list, checkout,add_to_cart, update_cart ,CartView,RemoveFromCartView
